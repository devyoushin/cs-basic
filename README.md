...
| [os-complete-guide.md](01_os/os-complete-guide.md) | OS 기초 완전 정리 — 메모리/동기화/파일시스템/syscall/I/O/스케줄링/네트워크 스택/부팅/cgroup |
...
| [load-handling.md](05_system-design/load-handling.md) | DB/Web 부하 진단, 즉시 완화, 캐시, 확장, 장애 대응 순서 |
...
| [proxy-deep-dive.md](deepdive/proxy-deep-dive.md) | Forward/Reverse/Transparent Proxy, Envoy Sidecar, SOCKS5, API Gateway, PROXY Protocol |
